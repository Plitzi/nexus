...
const Scoreboard = ({ stats }: { stats: StatConfig[] }) => (
  <div className="border-ink-700/70 bg-ink-900/60 pointer-events-auto flex max-w-full items-center gap-4 rounded-full border px-4 py-2.5 backdrop-blur-md @md:gap-7 @md:px-6">
    {stats.map(stat => (
