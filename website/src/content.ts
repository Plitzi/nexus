export const REPO_URL = 'https://github.com/Plitzi/nexus';
export const STORE_DIR_URL = 'https://github.com/Plitzi/nexus';
export const GITHUB_URL = 'https://github.com/Plitzi/nexus';
